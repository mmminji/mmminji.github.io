...
<p align="center"><img src="https://latex.codecogs.com/svg.image?output&space;=&space;\frac{input&plus;2*padding-filter}{stride}" title="https://latex.codecogs.com/svg.image?output = \frac{input+2*padding-filter}{stride}" /></p>
