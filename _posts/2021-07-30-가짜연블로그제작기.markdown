...
| 구분 | 의미 | 방향 | 의미 | 수치 | 의미 | 색 | 의미 |
|:---:|---|:---:|---|:---:|---|:---:|---|
|P|Padding|t|위|0|0|primary|파란색|
|M|Margin|b|아래|1|0.25rem(글자 크기 16px일 때, 4px)|secondary|회색|
|text-색|글자색|l|좌|2|0.5rem(글자 크기 16px일 때, 8px)|success|초록색|
|bg-색|배경색|r|우|3|1rem(글자 크기 16px일 때, 16px)|danger|빨간색|
|||x|좌 + 우|4|1.5rem(글자 크기 16px일 때, 24px)|warning|노란색|
|||y|위 + 아래|5|3rem(글자 크기 16px일 때, 48px)|light|흰색|
|||공백|위 + 아래 + 좌 + 우|auto|margin의 자동으로 세팅|white|흰색|
|||||||dark|검정색|
